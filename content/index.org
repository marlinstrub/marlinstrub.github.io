...
| [[id:news][*NEWS*]] | [[id:about][*ABOUT*]] | [[id:publications][*PUBLICATIONS*]] |
...
The [[https://www-robotics.jpl.nasa.gov/how-we-do-it/systems/exobiology-extant-life-surveyor-eels/][Exobiology Extant Life Surveyor (EELS)]] team wrote a paper that control and planning algorithms for EELS. One of the core ideas of the paper is to decouple shape control from motion control for screw-based gaits. The control strategy that gets EELS into a desired shape is distinct from the control strategy that propels EELS forward.
#+html: </details>
