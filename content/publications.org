...
#+html: <span id="vaquero_sr2024"></span>
- T. S. Vaquero, G. Daddi, R. Thakker, M. Paton, A. Jasour, M. P. Strub, R. M. Swan,  R. Royce /et al./ (2024) /EELS: Autonomous snake-like robot with task and motion planning capabilities for ice world exploration/. Science Robotics, 9(88): pages 1—11. ([[https://www.science.org/doi/full/10.1126/scirobotics.adh8332][open-access]], [[https://www.doi.org/10.1126/scirobotics.adh8332][doi]])
...
#+html: <span id="jasour_icra2025"></span>
- A. Jasour, G. Daddi, M. Endo, T. S. Vaquero, M. Paton, M. P. Strub, S. Corpino, M. Ingham, M. Ono, R. Thakker (2025) /Risk-aware integrated task and motion planning for versatile snake robots under localization failures/. In: Proceedings of the IEEE International Conference on Robotics and Automation (ICRA). pages 8880—8886. ([[https://arxiv.org/abs/2502.19690][open-access]], [[https://www.doi.org/10.1109/ICRA55743.2025.11127363][doi]])
#+html: <details><summary>Bibtex entry</summary>
#+begin_src bibtex
...
#+html: <span id="reid_aeroconf2024"></span>
- W. Reid, T. Bartlett, A. Bouton, M. P. Strub, M. Newby, S. Gerdts, J. Martin, S. Moreland, R. McCormick (2024) /Planning and control for autonomous drives of the mars sample recovery helicopter/. In: Proceedings of the IEEE Aerospace Conference (AeroConf). pages 1—11. ([[https://www.doi.org/10.1109/AERO58975.2024.10521039][doi]])
#+html: <details><summary>Bibtex entry</summary>
#+begin_src bibtex
...
#+html: <span id="paton_aeroconf2024"></span>
- M. Paton, /et al./ (incl. M. P. Strub) (2024) /2023 EELS field tests at Athabasca Glacier as an icy moon analogue environment/. In: Proceedings of the IEEE Aerospace Conference (AeroConf). pages 1—18. ([[https://www.doi.org/10.1109/AERO58975.2024.10521174][doi]])
#+html: <details><summary>Bibtex entry</summary>
#+begin_src bibtex
...
#+html: <span id="thakker_aiaa2024"></span>
- R. Thakker, M. Paton, B. Jones, G. Daddi, R. Royce, M. Swan, M. P. Strub, /et al./ (2024) /To boldly go where no robots have gone before — part 4: Neo autonomy for robustly exploring unknown, extreme environments with versatile robots/. AIAA SCITECH 2024 Forum, paper 1747. ([[https://www.doi.org/10.2514/6.2024-1747][doi]])
#+html: <details><summary>Bibtex entry</summary>
#+begin_src bibtex
...
#+html: <span id="strub_msc2017"></span>
- M. P. Strub (2017) /Exploring continuous representation of the world for place recognition/. M.Sc. Thesis, ETH Zurich.
#+html: <details><summary>Bibtex entry</summary>
#+begin_src bibtex
...
#+html: <span id="strub_bsc2015"></span>
- M. P. Strub (2015) /Model-based control of a bounding gait for a quadruped robot/. B.Sc. Thesis, ETH Zurich.
#+html: <details><summary>Bibtex entry</summary>
#+begin_src bibtex
