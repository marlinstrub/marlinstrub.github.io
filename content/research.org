...
My primary research interests are path planning and control algorithms. I'm passionate about and have experience in designing algorithms, analyzing them analytically, implementing them in C++, evaluating them empirically, and deploying them on real-world systems. I'm proud and humbled when I learn that my work has been useful to others. Some of my favorite examples of this include when researchers from
