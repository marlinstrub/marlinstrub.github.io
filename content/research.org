...
#+description: Path planning and control algorithm research by Marlin P. Strub, including AIT* and real-world deployments on NASA/JPL's Axel rover and EELS snake-like robot.

* Interests

#+begin_export html
<video width="210" autoplay loop muted playsinline style="float: right; outline: 2px solid black; outline-offset: -1px; margin: 0 0 0 1rem;" title="AIT* optimizing path length on random problems.">
  <source src="./assets/aitstar_teaser.mp4" type="video/mp4">
</video>
#+end_export
...
<center>
<div class="wrapper">
	<input type="radio" name="axel-slide" checked="checked" aria-label="Slide 1 of 8: Axel as part of DuAxel, driving on flat terrain.">
  <picture aria-label="Fig. 1: Axel as part of DuAxel, driving on flat terrain.">
	<img src="./assets/axel_01.jpg" alt="DuAxel driving.">
  </picture>

	<input type="radio" name="axel-slide" aria-label="Slide 2 of 8: Separating from the anchor, connected by tether.">
  <picture aria-label="Fig. 2: Separating from the anchor, connected by tether.">
	...
	<input type="radio" name="axel-slide" aria-label="Slide 3 of 8: The tether provides stability, power, and communication.">
  <picture aria-label="Fig. 3: The tether provides stability, power, and communication.">
	...
	<input type="radio" name="axel-slide" aria-label="Slide 4 of 8: Axel knows its surroundings and can avoid obstacles.">
  <picture aria-label="Fig. 4: Axel knows its surroundings and can avoid obstacles.">
	<img src="./assets/axel_04.jpg" alt="Axel scan.">
  </picture>

	<input type="radio" name="axel-slide" aria-label="Slide 5 of 8: This allows it to safely traverse steep slopes...">
  <picture aria-label="Fig. 5: This allows it to safely traverse steep slopes...">
	...
	<input type="radio" name="axel-slide" aria-label="Slide 6 of 8: ... and take scientific measurements of the soil.">
  <picture aria-label="Fig. 6: ... and take scientific measurements of the soil.">
	<img src="./assets/axel_06.jpg" alt="Axel 4">
  </picture>

	<input type="radio" name="axel-slide" aria-label="Slide 7 of 8: Our field-test site in the Mojave Desert, USA.">
  <picture aria-label="Fig. 7: Our field-test site in the Mojave Desert, USA.">
	<img src="./assets/axel_07.jpg" alt="Axel 4">
  </picture>

	<input type="radio" name="axel-slide" aria-label="Slide 8 of 8: Me, Axel, and Dr. Jonathan Gammell, my PhD advisor.">
...
<center>
<div class="wrapper">
	<input type="radio" name="eels-slide" checked="checked" aria-label="Slide 1 of 8: EELS 1.0 is about 4.4 m long and 100 kg in weight.">
  <picture aria-label="Fig. 9: EELS 1.0 is about 4.4 m long and 100 kg in weight.">
	...
	<input type="radio" name="eels-slide" aria-label="Slide 2 of 8: It has screws all along its body which can propel it.">
  <picture aria-label="Fig. 10: It has screws all along its body which can propel it.">
	...
	<input type="radio" name="eels-slide" aria-label="Slide 3 of 8: It also has 20 actuators to change its shape.">
  <picture aria-label="Fig. 11: It also has 20 actuators to change its shape.">
	<img src="./assets/eels_03.jpg" alt="EELS doing a scan.">
  </picture>

	<input type="radio" name="eels-slide" aria-label="Slide 4 of 8: We tested it on many surfaces, e.g., loose snow ...">
  <picture aria-label="Fig. 12: We tested it on many surfaces, e.g., loose snow ...">
	<img src="./assets/eels_04.jpg" alt="EELS on loose snow.">
  </picture>

	<input type="radio" name="eels-slide" aria-label="Slide 5 of 8: ...consolidated snow...">
  <picture aria-label="Fig. 13: ...consolidated snow...">
	<img src="./assets/eels_05.jpg" alt="EELS on consolidated snow.">
  </picture>

	<input type="radio" name="eels-slide" aria-label="Slide 6 of 8: ...glacial surface-ice...">
  <picture aria-label="Fig. 14: ...glacial surface-ice...">
	<img src="./assets/eels_06.jpg" alt="EELS on glacier.">
  </picture>

	<input type="radio" name="eels-slide" aria-label="Slide 7 of 8: ...and sand.">
  <picture aria-label="Fig. 15: ...and sand.">
	<img src="./assets/eels_07.jpg" alt="EELS on sand.">
  </picture>

	<input type="radio" name="eels-slide" aria-label="Slide 8 of 8: We even tested a later version in glacial moulins.">
