...
My primary research interests are path planning and control algorithms. I'm passionate about and have experience in designing algorithms, analyzing them analytically, implementing them in C++, evaluating them empirically, and deploying them on real-world systems. My work has been useful to other researchers, which I'm proud of. Some of my favorite examples of this include when researchers from
...
I have deployed my research on two of NASA/JPL's +coolest+ I mean subjectively most interesting rover prototypes: [[*Axel][Axel]] and [[*EELS][EELS]]. Here are short project-overviews that focus on my contributions and contain links to further information.
...
<div class="wrapper">
  ...
  <picture aria-label="Fig. 15: ...and sand.">
	...
	<input type="radio" name="eels-slide">
  <picture aria-label="Fig. 16: We even tested a later version inside glacial moulins.">
	<img src="./assets/eels_08.jpg" alt="EELS in moulin.">
  </picture>
  
	<input type="radio" name="eels-slide">
  <picture aria-label="Fig. 17: Sometimes I had to force it to do what I wanted...">
