...
Click on the list items to show/hide details.
...
A reference implementation of the final algorithm of my PhD thesis is now also publicly available in the [[https://ompl.kavrakilab.org/][Open Motion Planning Library (OMPL)]]. Implementing this has been more of a challenge than anticipated, both technically and schedule-wise.
#+html: </details>
